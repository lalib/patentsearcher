...
public class PatentSearcherConstant {
    ...
    public static final String PATENT_SCOPE_URL = "https://patentscope.wipo.int/search/en/result.jsf?query=FP:(weblogic)&office=&sortOption=Pub%20Date%20Desc&viewOption=Simple&currentNavigationRow=";
